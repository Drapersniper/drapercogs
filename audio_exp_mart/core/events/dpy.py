        ...
        if dj_enabled:
            ...
            if not dj_role_obj:
                ...
                await self.send_embed_msg(
                    ctx, title=_("No DJ role found. Disabling DJ mode."), error=True
                )
    ...
    async def cog_command_error(self, ctx: commands.Context, error: Exception) -> None:
        ...
        if not isinstance(
            ...
            message = (
                ...
                "Type: {type}\n"
                "The error has been received by the owner.```\n"
                "> If this error is appearing again join support server:"
                " https://discord.gg/TwCNvVz\n"
                "> The owner or a mod will help you when they are available."
            ).format(
