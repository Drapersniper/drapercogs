...
class CachingLevelManager:
    ...
    async def get(self, guild: discord.Guild) -> CacheLevel:
        ret: Optional[int]
        gid: int = guild.id
    ...
    async def set(self, guild: discord.Guild, set_to: Optional[int]) -> None:
        ...
        if set_to is not None:
            ...
            self._cached[gid] = constants.DEFAULT_COG_SETTINGS_GLOBAL["cache_level"]
